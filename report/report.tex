...
\section{Results}
In order to test the level set method described above, we started by
implementing a 2d version of the level set evolution in python (using NumPy,
SciPy, Scikit-fmm for solving the Eikonal equation and Matplotlib. Here are our
final 2d results. While the evolution
\begin{figure}[H]
  \centering
